...
data_csv=readData_csv('.\data\Flight8_0909\07_mag13_cabin\MAG13_4data_20240909_042522.csv');
...
tt_mag13=data_mag13_full(:,1);
tt_mag13_truth=data_mag13_truth_full(:,1);

data_mag13_sync=zeros(size(data_mag13_truth_full));

for i=1:size(tt_mag13_truth,1)
    [~, idx] = min(abs(tt_mag13 - tt_mag13_truth(i)));
    data_mag13_sync(i,:) = data_mag13_full(idx,:);
    if mod(i,100)==0
        disp(i);
    end
end
...
r1=findIdx(tt_mag13_truth,t1);
r2=findIdx(tt_mag13_truth,t2);
...
data_mag13=data_mag13_sync(range,:);
data_mag13_truth=data_mag13_truth_full(range,:);

save_file_name_mat='data/Flight8_0909/Flight8_0909_cabin.mat';
...
% save data to file;
save_file_name='data/Flight8_0909/Flight8_0909_cabin.txt';
...
% save info to file;
save_info_file_name='data/Flight8_0909/Flight8_0909_cabin_info.txt';
